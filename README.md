...
The first step is to fetch, filter and save data from Etsy's active listings. The `get_data.py` script is designed to do exactly this. The script interacts with Etsy's Open API v3. To check if your API works, you could first run:
